...
def hello_elementary():
    #Creates a "Standard" elementary window
    #The first argument is the name of our window
    #The second argument is the title displayed on the window bar
    ...
    #Content for our window
    #Creates a "Label" object which display text in our window
    #Whenever we create an elementary object we must provide a parent window as input
    ...
    #resize takes an ordered pair as input for the size for our window
    #the dimenions are pixel by pixel
